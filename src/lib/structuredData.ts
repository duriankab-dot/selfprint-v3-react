...
// Business contact information — optional SEO fields, graceful fallback to ''
// Note: Vite only inlines LITERAL import.meta.env.VITE_* — dynamic access returns undefined
const BUSINESS_PHONE = import.meta.env.VITE_BUSINESS_PHONE || '';
const BUSINESS_ADDRESS_STREET = import.meta.env.VITE_BUSINESS_ADDRESS_STREET || '';
const BUSINESS_ADDRESS_POSTAL = import.meta.env.VITE_BUSINESS_ADDRESS_POSTAL || '';
