...
const getNovaMessage = (ctaSource?: string): string => {
  switch (ctaSource) {
    case 'why':
      return 'จากส่วน "ทำไม" ที่คุณอ่าน ฉันรู้สึกว่าคุณอยากเข้าใจตัวเองมากขึ้น ตอนนี้ฉันเข้าใจรูปแบบการตัดสินใจของคุณ 60% แล้ว ช่วยตอบ 4 คำถามสั้นๆ เพื่อให้ฉันรู้จักคุณดีขึ้นไหม?';
    case 'how':
      return 'ฉันเห็นว่าคุณอยากเข้าใจกระบวนการ ตอนนี้ฉันเข้าใจวิธีตัดสินใจของคุณ 60% แล้ว ตอบ 4 คำถามเพื่อช่วยให้ฉันไปถึง 85% ได้ไหม?';
    case 'who':
      return 'คุณพร้อมเจาะลึกมากขึ้นแล้ว ตอนนี้ฉันเข้าใจว่าคุณเป็นใคร 60% แล้ว มาปรับความเข้าใจของฉันให้ละเอียดขึ้นด้วยอีก 4 คำถามไหม?';
    case 'next':
      return 'เริ่มกันเลย! ตอนนี้ฉันเข้าใจคุณ 60% แล้ว ช่วยให้ฉันไปถึงความแม่นยำ 85% ด้วยแค่ 4 คำถามสั้นๆ ไหม?';
    default:
      return 'ตอนนี้ฉันเข้าใจว่าคุณเป็นใคร 60% แล้ว ช่วยให้ฉันรู้จักคุณดีขึ้นไหม? แค่ 4 คำถามสั้นๆ จะพาฉันไปถึง 85%';
  }
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ✓ ช่วยให้รู้จักฉันดีขึ้น (4 คำถาม)
        </button>
        {onSkip && (
          <button
            onClick={onSkip}
