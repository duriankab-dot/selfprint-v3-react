...
| `npm run typecheck:functions` | PASS (`tsc -p tsconfig.functions.json --noEmit`) — re-verified 19 ก.ย. 2026 (esnext + bundler + force fix) |
| `npm run build` | PASS — re-verified 19 ก.ย. 2026 |
| `npm run lint` | PASS (oxlint, warnings only) — re-verified 19 ก.ย. 2026 |
| `npm test` | PASS — 1102/1102 (69 files; re-verified 19 ก.ย. 2026) |
