...
-- decision_log: Track all Twin decisions
...
CREATE INDEX IF NOT EXISTS idx_decision_log_twin_id ON decision_log(twin_id);
CREATE INDEX IF NOT EXISTS idx_decision_log_world ON decision_log(world);
